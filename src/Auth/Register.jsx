...
const Register = () => {
    ...
    return (
        <div className='flex justify-center items-center mt-10 md:min-h-screen mx-2 max-w-[1200px] md:mx-auto'>
            <div className="card bg-base-100 w-full md:max-w-sm shrink-0 shadow-2xl border border-accent-content">
                <form onSubmit={handleRegister} className="card-body mt-4">
                    {/* Google */}
                    <button
                        onClick={handleGoogleSignup}
                        type='button'
                        className="btn btn-secondary-content btn-outline ">
                    ...
                    <fieldset className="fieldset">
                        ...
                        <div className='flex items-center relative'>
                            <input
                                ...
                                required
                            />
                            <div onClick={() => setToggle(!toggle)} className='absolute text-primary-content ml-66 md:ml-70'>
                                {
                                    toggle ?
