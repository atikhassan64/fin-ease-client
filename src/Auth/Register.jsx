    ...
    return (
        <div className='flex justify-center items-center mt-10 md:min-h-screen max-w-11/12 mx-auto'>
            <div className="card bg-base-100 w-full md:max-w-sm shrink-0 shadow-2xl border border-accent">
                <h2 className='pt-6 text-center font-semibold text-2xl text-primary '>Signup your Account</h2>
                <form onSubmit={handleRegister} className="card-body">
                    ...
                    <p className='text-center font-medium text-secondary pt-3'>Already Have An Account ? <Link to={`/login`} className='text-primary font-bold'>Sign In</Link></p>
